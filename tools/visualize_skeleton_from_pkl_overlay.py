...
def visualize_skeleton_over_video(pkl_path, video_path, output="skeleton_overlay.mp4", person_id=0):
    ...
    while True:
        ...
        # Draw skeleton onto existing video frame
...
if __name__ == "__main__":
    ...
    parser.add_argument("--output", type=str, default="skeleton_overlay.mp4", help="Output video path")
    parser.add_argument("--person", type=int, default=0, help="Person ID to draw")
    args = parser.parse_args()

    visualize_skeleton_over_video(
